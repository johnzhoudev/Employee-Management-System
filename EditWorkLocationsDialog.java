 ...
 * @author 565174
 */
public class EditWorkLocationsDialog extends javax.swing.JDialog {

    /**
     * Creates new form addWorkLocationDialog
     */
    public EditWorkLocationsDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Add Work Location Wizard", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14), new java.awt.Color(255, 102, 102))); // NOI18N

        jLabel1.setText("To add a work location, input the name of the work location and click the \"Add Location\" button.");

        jLabel2.setText("Work Location Name:");

        workLocationTextField.setText("jTextField1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditWorkLocationsDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditWorkLocationsDialog dialog = new EditWorkLocationsDialog(new javax.swing.JFrame(), true);
